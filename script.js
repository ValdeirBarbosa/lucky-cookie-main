...
const btnOpenCookie = document.querySelector(".screen1 main img");
const btnReset = document.querySelector("button");

const mainScreen1 = document.querySelector(".screen1")
const mainScreen2 = document.querySelector(".screen2")
...
function toggleScreen() {
    document.querySelector(".container-msg").textContent = randomFrase()
    document.querySelector(".screen1").classList.toggle("hiden");
    document.querySelector(".screen2").classList.toggle("hiden");
  ...
  function randomFrase(){
    let randNum = Math.round(Math.random() * frases.length);

    return frases[randNum]
  }
